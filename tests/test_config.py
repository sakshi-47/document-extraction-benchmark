...
from docfit.auth import MissingTokenError, Token, get_token
from docfit.hardware import Device, detect_device
from docfit.train.config import RunConfig, load_run_config
from docfit.train.loop import resolve_precision
...
class TestPrecision:
    ...
    def test_explicit_bf16_on_pre_ampere_is_an_error(self, monkeypatch):
        ...
        monkeypatch.setattr("docfit.train.loop.detect_device", lambda: pascal)
